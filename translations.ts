...
export const translations: Translations = {
  ...
  Rapid_Service: { en: "Rapid Service", it: "Rapid Service" },
  ...
  New_here: { en: "New here?", it: "Nuovo qui?" },
  Create_account: { en: "Create account", it: "Crea account" },
  My_Bookings: { en: "My Bookings", it: "Le Mie Prenotazioni" },
  View_All: { en: "View All", it: "Vedi Tutto" },
  Read_full_article: { en: "Read full article", it: "Leggi l'articolo completo" },
  Go_to_Top: { en: "Go to Top", it: "Torna in Alto" },
  ...
  Verifying_your_link: { en: "Verifying your link...", it: "Verifica del link in corso..." },
  Invalid_or_expired_reset_link: { en: "This password reset link is invalid or has expired. Please request a new one.", it: "Questo link di reimpostazione password non è valido o è scaduto. Richiedi un nuovo link." },
  Link_Invalid: { en: "Link Invalid", it: "Link Non Valido" },
  Request_New_Link: { en: "Request New Link", it: "Richiedi Nuovo Link" },
