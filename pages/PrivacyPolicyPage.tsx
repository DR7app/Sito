...
const PrivacyPolicyPage: React.FC = () => {
    ...
    return (
        <LegalPageLayout title={t({ it: 'Informativa sulla Privacy', en: 'Privacy Policy' })}>
            ...
            <p>{t({ it: "Se hai domande su questa Informativa sulla Privacy, contatta il nostro Responsabile della Privacy dei Dati all'indirizzo:", en: 'If you have questions about this Privacy Policy, contact our Data Privacy Officer at:' })} <a href="mailto:info@dr7.app">{t({ it: 'info@dr7.app', en: 'info@dr7.app' })}</a>.</p>
        </LegalPageLayout>
    );
};
