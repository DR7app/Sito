          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
              ...
              <div className="lg:col-span-1">
                <button onClick={handleSearch} className="w-full bg-white text-black font-bold py-3 px-4 hover:bg-gray-200 transition-colors flex items-center justify-center">
                  {t('Search')}
                </button>
              </div>
              <div>
        ...
        {!expanded && (
          <div className="flex items-center gap-4 py-3 flex-wrap">
            ...
            <div className="ml-auto flex items-center gap-3 shrink-0">
              <span className="px-3 py-1 bg-white/10 text-xs text-gray-300 hidden sm:inline">
                {(() => {
        ...
        {expanded && (
          <div className="py-4 space-y-4">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={handleSave}
                className="bg-white text-black font-bold text-sm px-6 py-2.5 hover:bg-gray-200 transition-colors"
              >
    ...
    (async () => {
      try {
        ...
        setInitialSearchDates({
          ...
          // come scelti al momento del preventivo. Accettiamo entrambe le
          // chiavi (snake_case e camelCase) perche' i preventivi vecchi
          // erano stati salvati con la variante camelCase.
          kmPackageType: preventivo.extras_detail?.km_package_type
            || preventivo.extras_detail?.kmPackageType
            || undefined,
          kmPackages: preventivo.extras_detail?.km_packages
            || preventivo.extras_detail?.kmPackages
            || undefined,
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <button
              ...
              className="bg-gray-800 text-white px-8 py-3 font-semibold hover:bg-gray-700 transition-colors"
            >
                ...
                <div className="bg-white rounded-2xl p-6 md:p-10 shadow-2xl">
                  ...
                  >
                    ...
                    <div className="pt-4">
                      <button
                        type="submit"
                        className="w-full flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#1ebe57] text-white text-lg font-bold py-4 transition-colors duration-200 shadow-lg"
                      >
