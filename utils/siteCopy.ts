...
export const DEFAULT_FRANCHISING: FranchisingCopy = {
  ...
  stats_heading: '30 mesi di crescita.\nLe fondamenta sono costruite.',
  stats_heading_it: '30 mesi di crescita.\nLe fondamenta sono costruite.',
  ...
  stats_lines: [
    ...
    '€6M+ patrimonio netto',
    '€1M capitale sociale',
    '{reviewCount}+ recensioni a 5 stelle',
    '€5M valutazione del brand*',
    '€15M valutazione aziendale*',
  ],
  stats_lines_it: [
    '4.000+ contratti di noleggio firmati',
    '3.000+ clienti serviti nell\'ecosistema DR7',
  ...
  stats_lines_en: [
    ...
    '€5M brand valuation*',
    '€15M company valuation*',
  ],
  stats_footer_main: 'Da S.R.L. a S.P.A. in un solo anno.',
  stats_footer_main_it: 'Da S.R.L. a S.P.A. in un solo anno.',
  stats_footer_main_en: 'From S.R.L. to S.P.A. in a single year.',
  stats_footer_sub: 'Costruita in Italia.\nProgettata per scalare oltre i confini.\n\nDR7 S.p.A.',
  stats_footer_sub_it: 'Costruita in Italia.\nProgettata per scalare oltre i confini.\n\nDR7 S.p.A.',
  stats_footer_sub_en: 'Built in Italy.\nDesigned to scale beyond borders.\n\nDR7 S.p.A.',
...
const DEFAULT_INVESTITORI: InvestitoriCopy = {
  ...
  ir_v2030_motto_it: 'Lusso. Tecnologia. Persone. Pianeta.', ir_v2030_motto_en: 'Luxury. Technology. People. Planet.',
  ...
  ir_v2030_claim_it: 'La piattaforma del lusso di nuova generazione', ir_v2030_claim_en: 'The next generation luxury platform',
  ir_v2030_sottoclaim_it: 'Asset reali. Potenza digitale. Impatto globale.', ir_v2030_sottoclaim_en: 'Real assets. Digital power. Global impact.',
  ir_v2030_pilastri: [
    { id: 'mobilita', icona: 'auto', titolo_it: 'Mobilità', titolo_en: 'Mobility', testo_it: 'Premium e oltre', testo_en: 'Premium & Beyond' },
    { id: 'aviazione', icona: 'aereo', titolo_it: 'Aviazione', titolo_en: 'Aviation', testo_it: 'Jet privati', testo_en: 'Private Jets' },
    { id: 'real-estate', icona: 'patrimonio', titolo_it: 'Immobiliare', titolo_en: 'Real Estate', testo_it: 'Ville, resort, location', testo_en: 'Villas, resorts, locations' },
    { id: 'hospitality', icona: 'clienti', titolo_it: 'Ospitalità', titolo_en: 'Hospitality', testo_it: 'Esperienze esclusive', testo_en: 'Exclusive experiences' },
    { id: 'tech', icona: 'chip', titolo_it: 'Tecnologia e IA', titolo_en: 'Tech & AI', testo_it: 'Piattaforme proprie', testo_en: 'Proprietary platforms' },
  ...
  ir_v2030_chiusura_it: 'Investi oggi. Fai parte di un domani migliore.', ir_v2030_chiusura_en: 'Invest today. Be part of a brighter tomorrow.',
  ...
  ir_azionisti: [
    { id: 'privato-1', nome: 'Andrea Onano', ruolo_it: 'Investitore privato · 4.950 €', ruolo_en: 'Private investor · €4,950', da_it: 'Azionista dal 2026', da_en: 'Shareholder since 2026', foto: '' },
  ...
  ir_privati_eyebrow_it: 'Investitori', ir_privati_eyebrow_en: 'Investors',
  ir_privati_titolo_it: '2 investitori', ir_privati_titolo_en: '2 investors',
  ir_privati_testo_it: 'Al momento, una società e un investitore privato hanno scelto di credere nel nostro progetto e di accompagnarci nel percorso di crescita.',
  ir_privati_testo_en: 'At present, a company and a private investor have chosen to believe in our project and to join us on our growth path.',
  ir_privati_img: '',
  ir_privati_stat: [
    { id: 'capitale', icona: 'capitale', valore: '204.950 €', label_it: 'capitale raccolto', label_en: 'capital raised', nota_it: '200.000 € società · 4.950 € privato', nota_en: '€200,000 company · €4,950 private' },
    { id: 'investitori', icona: 'clienti', valore: '2', label_it: 'investitori', label_en: 'investors', nota_it: '1 società · 1 privato', nota_en: '1 company · 1 private' },
  ...
  ir_riservati_testo_it: 'La società che ha investito ha scelto di mantenere la propria riservatezza. Rispettare la sua scelta è per noi una priorità.',
  ir_riservati_testo_en: 'The investing company has chosen to keep its identity confidential. Respecting that choice is a priority for us.',
  ir_riservati_label_it: 'Società riservata', ir_riservati_label_en: 'Confidential company',
  ir_riservati_nota_it: '200.000 € · Partecipazione al capitale', ir_riservati_nota_en: '€200,000 · Equity participation',
  ...
  ir_partner_testo_it: 'Le testate che hanno raccontato la crescita di DR7 e dei suoi fondatori. Tocca un logo per leggere l\'articolo.',
  ir_partner_testo_en: 'The publications that have covered the growth of DR7 and its founders. Tap a logo to read the article.',
  ir_partner_bottone_it: 'Leggi la rassegna stampa', ir_partner_bottone_en: 'Read the press coverage',
  ir_partner_link: '/press',
  ir_partner_img: '',
  ir_partner_loghi: [
    { id: 'forbesmiami', nome: 'Forbes Miami', logo: '/loghi-stampa/forbes-miami.png', link: 'https://forbesmia.com/2026/06/16/from-e10000-to-a-e5-million-brand-how-valerio-saia-and-ilenia-campagnola-built-dr7-through-reinvestment-and-technology/' },
    { id: 'fortuneitalia', nome: 'Fortune Italia', logo: '/loghi-stampa/fortune-italia.png', link: 'https://www.fortuneita.com/2026/06/05/valerio-saia-e-ilenia-campagnola-gli-imprenditori-che-hanno-trasformato-10-000-euro-in-un-marchio-valutato-5-milioni-di-euro-in-due-anni/' },
    { id: 'iltempo', nome: 'Il Tempo', logo: '/loghi-stampa/il-tempo.png', link: 'https://www.iltempo.it/attualita/2026/06/01/news/dr7-da-startup-della-mobilita-premium-a-realta-luxury-tech-47983233/' },
    { id: 'libero', nome: 'Libero Quotidiano', logo: '/loghi-stampa/libero-quotidiano.png', link: 'https://www.liberoquotidiano.it/news/general/48180927/valerio-saia-e-ilenia-campagnola-pronti-via-in-due-anni-da-10mila-euro-a-5-milioni.html' },
    { id: 'iltirreno', nome: 'Il Tirreno', logo: '/loghi-stampa/il-tirreno.png', link: 'https://www.iltirreno.it/italia-mondo/cronaca/2026/06/03/news/valerio-saia-e-ilenia-campagnola-gli-imprenditori-che-hanno-trasformato-10-000-euro-in-un-marchio-valutato-5-milioni-di-euro-in-due-anni-1.100877939' },
    { id: 'affaritaliani', nome: 'Affaritaliani', logo: '/loghi-stampa/affaritaliani.png', link: 'https://share.google/cKzx4LrDZGYtVj0X5' },
    { id: 'ilroma', nome: 'Il Roma', logo: '/loghi-stampa/il-roma.png', link: 'https://www.ilroma.net/news/costume/861890/valerio-saia-e-ilenia-campagnola-gli-imprenditori-che-hanno-trasformato-10-000-euro-in-un-marchio-valutato-5-milioni-di-euro-in-due-anni.html' },
  ],
...
const DEFAULT_PRESS: PressCopy = {
  ...
  articles: [
    {
      id: "art-todaynews",
      title: "How Valerio Saia and Ilenia Campagnola Are Expanding DR7 Beyond Luxury Cars",
      publication: "Today News",
      date: "23 Luglio 2026",
      summary_it: "Today News racconta come Valerio Saia e Ilenia Campagnola stanno portando DR7 oltre il noleggio di auto di lusso, verso un ecosistema luxury-tech fatto di sistemi operativi, servizi e tecnologia.",
      summary_en: "Today News explains how Valerio Saia and Ilenia Campagnola are taking DR7 beyond luxury car rental, towards a luxury-tech ecosystem built on operating systems, services and technology.",
      link: "https://todaynews.co.uk/2026/07/23/how-valerio-saia-and-ilenia-campagnola-are-expanding-dr7-beyond-luxury-cars/",
    },
    {
      id: "art-streetinsider",
      title: "Valerio Saia Builds DR7 From One Premium Car Into a Luxury-Tech Ecosystem",
      publication: "StreetInsider",
      date: "2026",
      summary_it: "StreetInsider (Globe PR Wire) ripercorre come Valerio Saia ha costruito DR7 partendo da una sola auto premium fino a un ecosistema luxury-tech.",
      summary_en: "StreetInsider (Globe PR Wire) traces how Valerio Saia built DR7 from a single premium car into a luxury-tech ecosystem.",
      link: "https://www.streetinsider.com/Globe+PR+Wire/Valerio+Saia+Builds+DR7+From+One+Premium+Car+Into+a+Luxury-Tech+Ecosystem/26798385.html",
    },
    {
      id: "art-talkymedia",
      ...
      publication: "TalkyMedia",
      date: "8 Giugno 2026",
      summary_it: "TalkyMedia racconta la crescita di DR7: da un investimento iniziale di 10.000 euro a un marchio valutato 5 milioni di euro in due anni.",
      summary_en: "TalkyMedia covers DR7's growth: from an initial 10,000 euro investment to a brand valued at 5 million euro in two years.",
      link: "https://www.talkymedia.it/valerio-saia-e-ilenia-campagnola-gli-imprenditori-che-hanno-trasformato-10-000-euro-in-un-marchio-valutato-5-milioni-di-euro-in-due-anni/",
    },
    {
      id: "art-newspeople",
      title: "Valerio Saia e Ilenia Campagnola, gli imprenditori che hanno trasformato 10.000 euro in un marchio valutato 5 milioni di euro in due anni",
      publication: "News People",
      date: "8 Giugno 2026",
      summary_it: "News People dedica un articolo a Valerio Saia e Ilenia Campagnola e al percorso che ha portato DR7 da 10.000 euro a un marchio da 5 milioni.",
      summary_en: "News People profiles Valerio Saia and Ilenia Campagnola and the journey that took DR7 from 10,000 euro to a 5 million euro brand.",
      link: "https://www.newspeople.it/2026/06/08/valerio-saia-e-ilenia-campagnola-gli-imprenditori-che-hanno-trasformato-10-000-euro-in-un-marchio-valutato-5-milioni-di-euro-in-due-anni/",
    },
    {
      id: "art-studiolive24",
      title: "Valerio Saia e Ilenia Campagnola, gli imprenditori che hanno trasformato 10.000 euro in un marchio valutato 5 milioni di euro in due anni",
      publication: "StudioLive24",
      date: "8 Giugno 2026",
      summary_it: "StudioLive24 ripercorre la storia di DR7 e dei suoi fondatori, dalla prima auto premium a un marchio valutato 5 milioni di euro.",
      summary_en: "StudioLive24 retraces the story of DR7 and its founders, from the first premium car to a brand valued at 5 million euro.",
      link: "https://www.studiolive24.it/valerio-saia-e-ilenia-campagnola-gli-imprenditori-che-hanno-trasformato-10-000-euro-in-un-marchio-valutato-5-milioni-di-euro-in-due-anni/",
    },
    {
      id: "art-agenziastampa",
      title: "Valerio Saia e Ilenia Campagnola, gli imprenditori che hanno trasformato 10.000 euro in un marchio valutato 5 milioni di euro in due anni",
      publication: "Agenzia di Stampa Internazionale",
      date: "8 Giugno 2026",
      summary_it: "L'Agenzia di Stampa Internazionale racconta come Valerio Saia e Ilenia Campagnola hanno fatto crescere DR7 in poco più di due anni.",
      summary_en: "Agenzia di Stampa Internazionale reports how Valerio Saia and Ilenia Campagnola grew DR7 in little more than two years.",
      link: "https://www.agenziadistampainternazionale.it/2026/06/08/valerio-saia-e-ilenia-campagnola-gli-imprenditori-che-hanno-trasformato-10-000-euro-in-un-marchio-valutato-5-milioni-di-euro-in-due-anni/",
    },
    {
      id: "art-incopertina",
      title: "Valerio Saia e Ilenia Campagnola, gli imprenditori che hanno trasformato 10.000 euro in un marchio valutato 5 milioni di euro in due anni",
      publication: "in COPERTINA",
      date: "8 Giugno 2026",
      summary_it: "in COPERTINA dedica un articolo ai fondatori di DR7 e alla crescita del marchio nella mobilità premium e nei servizi luxury.",
      summary_en: "in COPERTINA features DR7's founders and the brand's growth in premium mobility and luxury services.",
      link: "https://www.incopertina.it/2026/06/08/valerio-saia-e-ilenia-campagnola-gli-imprenditori-che-hanno-trasformato-10-000-euro-in-un-marchio-valutato-5-milioni-di-euro-in-due-anni/",
    },
    {
      id: "art-iltempo",
      title: "DR7: da startup della mobilità premium a realtà luxury-tech",
      publication: "Il Tempo",
      date: "1 Giugno 2026",
      summary_it: "Il Tempo racconta come in poco più di due anni DR7 è passata da giovane realtà nata a Cagliari a un progetto che unisce mobilità premium, servizi luxury e tecnologia.",
      summary_en: "Il Tempo describes how, in little more than two years, DR7 grew from a young Cagliari company into a project combining premium mobility, luxury services and technology.",
      link: "https://www.iltempo.it/attualita/2026/06/01/news/dr7-da-startup-della-mobilita-premium-a-realta-luxury-tech-47983233/",
    },
    {
      id: "art-medium",
      title: "Ilenia Campagnola, l'imprenditrice che ha trasformato 10.000 euro in un marchio da 5 milioni",
      publication: "Medium",
      date: "2026",
      summary_it: "Su Medium il ritratto di Ilenia Campagnola, co-fondatrice di DR7, e del percorso che ha trasformato 10.000 euro in un marchio valutato 5 milioni.",
      summary_en: "On Medium, a portrait of Ilenia Campagnola, DR7 co-founder, and the path that turned 10,000 euro into a brand valued at 5 million.",
      link: "https://medium.com/@4feature.com/ilenia-campagnola-imprenditrice-ha-trasformato-10-000-60cb93bccd57",
    },
    {
      id: 'art-7',
...
const DEFAULT_CANCELLAZIONE: CancellazioneCopy = {
  ...
  sections: [
    ...
    },
    {
      id: 'prime-flex',
      variant: 'flex',
      title_it: '8. Servizio opzionale "DR7 FLEX" (solo lavaggio)',
      title_en: '8. Optional "DR7 FLEX" service (car wash only)',
      blocks: [
        { type: 'p',
          text_it: 'DR7 FLEX è un servizio opzionale acquistabile in fase di prenotazione del lavaggio. Non è applicabile ad altri servizi.',
          text_en: 'DR7 FLEX is an optional service purchasable when booking a car wash. It does not apply to other services.' },
        { type: 'p', text_it: 'Condizioni:', text_en: 'Terms:' },
        { type: 'ul', tone: 'green',
